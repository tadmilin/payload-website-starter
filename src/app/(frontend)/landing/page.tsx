      ...
      <div className="relative z-20 flex flex-col items-center justify-center min-h-screen">
        ...
        <section className="container mx-auto px-4 py-10 flex flex-col items-center text-center">
          ...
          <p className="text-xl text-white/80 max-w-3xl mb-12">
            ลดค่าไฟฟ้าด้วยระบบโซลาร์เซลล์คุณภาพสูง ติดตั้งง่าย ดูแลระยะยาว คุ้มค่าการลงทุน
          </p>
          <Link
            href="/home"
        ...
        <section className="container mx-auto px-4 py-8 grid md:grid-cols-2 gap-16">
          <div className="flex flex-col bg-black/40 p-8 rounded-lg">
            ...
            <p className="text-slate-300 mb-4">
              เรามีบริการติดตั้งโซลาร์เซลล์คุณภาพสูง รับประกันผลงาน มีทีมงานมืออาชีพ พร้อมให้คำแนะนำการใช้งานและการบำรุงรักษาระยะยาว
            </p>
          </div>
          <div className="flex flex-col bg-black/40 p-8 rounded-lg">
            ...
            <p className="text-slate-300 mb-4">
              ลงทุนครั้งเดียว ประหยัดค่าไฟไปได้หลายสิบปี ช่วยลดค่าใช้จ่ายในระยะยาว และยังเป็นมิตรกับสิ่งแวดล้อม ลดการปล่อยก๊าซเรือนกระจก
            </p>
          </div>
        </section>
      </div>
